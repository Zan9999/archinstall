...
arch-chroot /mnt /bin/bash -c "pacman -S --needed --noconfirm mesa lib32-mesa vulkan-intel lib32-vulkan-intel vulkan-icd-loader lib32-vulkan-icd-loader nvidia-open-dkms nvidia-utils lib32-nvidia-utils nvidia-settings egl-wayland lib32-opencl-nvidia opencl-nvidia libxnvctrl"
