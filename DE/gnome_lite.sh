...
sleep 3
arch-chroot /mnt /bin/bash -c "setcap CAP_SYS_NICE=+ep /usr/bin/gnome-shell"
arch-chroot /mnt /bin/bash -c "gsettings set org.gnome.mutter experimental-features \"['rt-scheduler']\""
